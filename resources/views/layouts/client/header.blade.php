...
<div class="nav-inner">
    ...
    <div class="nav-links">
        ...
        <a href="{{ route('services.index') }}" @class(['active' => request()->routeIs('services.*') || request()->routeIs('pages.show')])>Layanan</a>
        <a href="{{ route('articles.index') }}" @class(['active' => request()->routeIs('articles.*')])>Artikel</a>
    </div>
    <a href="{{ $waUrl }}" target="_blank" rel="noopener noreferrer" class="nav-wa" aria-label="Chat WhatsApp EditDokumen.id">
        <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
